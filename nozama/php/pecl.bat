...
FOR %%x IN ("C:\Documents and Settings\XPMUser\Bureau\xampp\php\pear") DO (if %%x=="%PMTPMTPMT%" GOTO :NOTINSTALLED)

REM Check PEAR global ENV, set them if they do not exist
IF "%PHP_PEAR_INSTALL_DIR%"=="" SET "PHP_PEAR_INSTALL_DIR=C:\Documents and Settings\XPMUser\Bureau\xampp\php\pear"
IF "%PHP_PEAR_BIN_DIR%"=="" SET "PHP_PEAR_BIN_DIR=C:\Documents and Settings\XPMUser\Bureau\xampp\php"
IF "%PHP_PEAR_PHP_BIN%"=="" SET "PHP_PEAR_PHP_BIN=C:\Documents and Settings\XPMUser\Bureau\xampp\php\.\php.exe"
GOTO :INSTALLED
