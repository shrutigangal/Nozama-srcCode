...
::            for PHP 4.3 C:\phpdev\php-4.3-Win32\cli\php.exe
  ...
  SET phpCli=C:\Documents and Settings\XPMUser\Bureau\xampp\php\.\php.exe
...
"%phpCli%" -d html_errors=off -qC "C:\Documents and Settings\XPMUser\Bureau\xampp\php\pear\phing.php" %*
GOTO :EOF
